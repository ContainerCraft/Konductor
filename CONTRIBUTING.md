...
Thank you for considering contributing to the Zora project! Your contributions help improve the platform and empower the community. This guide provides all the information you need to contribute effectively and harmoniously.
...
To contribute to the Zora project, ensure you have the following installed:
...
The Zora project utilizes the ContainerCraft Devcontainer to provide a consistent and fully-configured development environment. Follow these steps to get started:

1. **Fork the Repository**

   Click the "Fork" button at the top of the [Zora GitHub repository](https://git.smce.nasa.gov/scip/zora.git) to create your own fork.
...
2. **Open a New Issue**
   ...
   - Navigate to the [Issues](https://git.smce.nasa.gov/scip/zora/-/issues) page.
...
We welcome suggestions to improve Zora:
...
2. **Open a New Issue**
   ...
   - Go to the [Issues](https://git.smce.nasa.gov/scip/zora/-/issues) page.
...
By contributing to Zora, you agree that your contributions will be licensed under the [Adaptive Public License 1.0](./LICENSE). This ensures that the project remains free and open-source, benefiting the entire community.

---

## Acknowledgments

We appreciate every contributor who invests time and effort into making Zora better. Your contributions, whether through code, documentation, testing, or discussions, are invaluable.
